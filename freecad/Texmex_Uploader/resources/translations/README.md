# About translating Texmex_Uploader Workbench

> [!NOTE]
> All commands **must** be run in `./freecad/Texmex_Uploader/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **Texmex_Uploader** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **Texmex_Uploader** translatable strings execute
...
Also you can rename new `Texmex_Uploader.ts` file by appending the locale code,
...
once done, look for the **Texmex_Uploader** project.
...
Now you can contribute your translated `.ts` file to **Texmex_Uploader** repository,
also include the `.qm` file.

<https://github.com/mttotmw/TexmexUploader>
